...
void __stdcall c_render::init( IDirect3DDevice9* device )
{
  ...
  if( !init )
  {
    ...
    cfg.MergeMode = true;
    cfg.DstFont = g_fonts.esp;
    io.Fonts->AddFontFromFileTTF( "C:\\Windows\\Fonts\\msyh.ttc", 12.f, &cfg, io.Fonts->GetGlyphRangesChineseSimplifiedCommon( ) );
    cfg.MergeMode = false;
    cfg.DstFont = nullptr;
    ...
    cfg.MergeMode = true;
    cfg.DstFont = g_fonts.main;
    io.Fonts->AddFontFromFileTTF( "C:\\Windows\\Fonts\\msyh.ttc", 14.f, &cfg, io.Fonts->GetGlyphRangesChineseSimplifiedCommon( ) );
    cfg.MergeMode = false;
    cfg.DstFont = nullptr;
    ...
    cfg.MergeMode = true;
    cfg.DstFont = g_fonts.large;
    io.Fonts->AddFontFromFileTTF( "C:\\Windows\\Fonts\\msyh.ttc", 30.f, &cfg, io.Fonts->GetGlyphRangesChineseSimplifiedCommon( ) );
    cfg.MergeMode = false;
    cfg.DstFont = nullptr;
    ...
    cfg.MergeMode = true;
    cfg.DstFont = g_fonts.bold;
    io.Fonts->AddFontFromFileTTF( "C:\\Windows\\Fonts\\msyh.ttc", 10.f, &cfg, io.Fonts->GetGlyphRangesChineseSimplifiedCommon( ) );
    cfg.MergeMode = false;
    cfg.DstFont = nullptr;
    ...
    cfg.MergeMode = true;
    cfg.DstFont = g_fonts.bold_large;
    io.Fonts->AddFontFromFileTTF( "C:\\Windows\\Fonts\\msyh.ttc", 26.f, &cfg, io.Fonts->GetGlyphRangesChineseSimplifiedCommon( ) );
    cfg.MergeMode = false;
    cfg.DstFont = nullptr;
    ...
    cfg.MergeMode = true;
    cfg.DstFont = g_fonts.dmg;
    io.Fonts->AddFontFromFileTTF( "C:\\Windows\\Fonts\\msyh.ttc", 18.f, &cfg, io.Fonts->GetGlyphRangesChineseSimplifiedCommon( ) );
    cfg.MergeMode = false;
    cfg.DstFont = nullptr;
